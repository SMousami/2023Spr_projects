...
#Experiment 2 tests hypothesis 2 by creating a list of different fan speeds. This same experiment can also be done with the above code by manually changing the fan speed
